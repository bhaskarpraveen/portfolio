      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          {projects.map((project, index) => (
            <div
              key={index}
              className="bg-gray-900 border border-gray-700 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group"
            >
              <div className="h-40 sm:h-48 bg-gradient-to-br from-purple-600 to-blue-600 relative overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-white text-4xl sm:text-6xl font-bold opacity-30 group-hover:opacity-40 transition-all duration-300">
              ...
              <div className="p-4 sm:p-6">
                <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 text-white group-hover:text-purple-400 transition-colors leading-tight">
                  {project.title}
                </h3>
                ...
                <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-4 sm:mb-6">
                  {project.technologies.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className="px-2 sm:px-3 py-1 bg-purple-900 text-purple-300 text-xs sm:text-sm font-medium rounded-full border border-purple-700"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
                  <a
                    ...
                    className="flex-1 bg-gray-800 text-white py-2.5 sm:py-2 px-4 rounded-lg text-center hover:bg-gray-700 transition-colors border border-gray-600 text-sm sm:text-base"
                  >
                    View Code
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 bg-gradient-to-r from-purple-600 to-blue-600 text-white py-2.5 sm:py-2 px-4 rounded-lg text-center hover:from-purple-700 hover:to-blue-700 transition-all duration-300 text-sm sm:text-base"
                  >
                    Live Demo
                  </a>
                </div>
        ...
        <div className="text-center mt-8 sm:mt-12">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 bg-gray-800 text-white rounded-full hover:bg-gray-700 transition-colors border border-gray-600 text-sm sm:text-base"
          >
